...
import com.stackroute.knowledgevault.paragraphtokenizer.kafka.Consumer;
	...
	public static class Config {
		...
		public Consumer consumer() {
			return new Consumer() {
				...
				@Override
				public void processMessage(String message, List<Integer> partitions, List<String> topics, List<Long> offsets) {
